...
export type MatchErrorInput = Enum<{ CantMatch: [string, string], CantMatchMany: [] }>;
...
export enum ValueErrorInput { InvalidAmount = 'InvalidAmount', InvalidArrayLength = 'InvalidArrayLength' };
export enum ValueErrorOutput { InvalidAmount = 'InvalidAmount', InvalidArrayLength = 'InvalidArrayLength' };
