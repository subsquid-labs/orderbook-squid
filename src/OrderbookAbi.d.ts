...
export type MarketCreateEventInput = {
  asset_id: AssetIdInput;
  asset_decimals: BigNumberish;
  timestamp: BigNumberish;
  tx_id: string;
};
export type MarketCreateEventOutput = {
...
export type OrderOutput = {
  id: string;
  trader: AddressOutput;
  base_token: AssetIdOutput;
  base_size: I64Output;
  base_price: BN;
};
export type OrderChangeEventInput = {
  order_id: string;
  sender: IdentityInput;
  timestamp: BigNumberish;
  identifier: OrderChangeEventIdentifierInput;
  tx_id: string;
  order: Option<OrderInput>;
};
export type OrderChangeEventOutput = {
  order_id: string;
  sender: IdentityOutput;
  timestamp: BN;
  identifier: OrderChangeEventIdentifierOutput;
  tx_id: string;
  order: Option<OrderOutput>;
};
export type TradeEventInput = {
  base_token: AssetIdInput;
  order_matcher: AddressInput;
  seller: AddressInput;
  buyer: AddressInput;
...
export type TradeEventOutput = {
  base_token: AssetIdOutput;
  order_matcher: AddressOutput;
...
interface OrderbookAbiInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [AssetIdInput, BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [AssetIdInput, I64Input, BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
...
export class OrderbookAbi extends Contract {
  ...
  functions: {
    ...
    create_market: InvokeFunction<
      [asset_id: AssetIdInput, asset_decimals: BigNumberish],
      void
    >;
    ...
    get_order_change_events_by_order: InvokeFunction<
      [order: string],
      Vec<OrderChangeEventOutput>
    >;
    market_exists: InvokeFunction<[asset_id: AssetIdInput], boolean>;
    match_orders: InvokeFunction<
      [order_sell_id: string, order_buy_id: string],
      void
    >;
    open_order: InvokeFunction<
      [base_token: AssetIdInput, base_size: I64Input, base_price: BigNumberish],
      string
    >;
