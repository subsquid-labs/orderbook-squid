...
exports.OrderbookAbi__factory = exports._abi = void 0;
/* tslint:disable */
/* eslint-disable */
/*
...
const _storageSlots = [];
class OrderbookAbi__factory {
    static createInterface() {
        //@ts-ignore
        return new fuels_1.Interface(exports._abi);
    }
    static connect(id, accountOrProvider) {
        //@ts-ignore
        return new fuels_1.Contract(id, exports._abi, accountOrProvider);
    }
    static async deployContract(bytecode, wallet, options = {}) {
        //@ts-ignore
        const factory = new fuels_1.ContractFactory(bytecode, exports._abi, wallet);
...
exports.OrderbookAbi__factory = OrderbookAbi__factory;
OrderbookAbi__factory.abi = exports._abi;
OrderbookAbi__factory.storageSlots = _storageSlots;
//# sourceMappingURL=OrderbookAbi__factory.js.map