module.exports = class Data1718889509476 {
    name = 'Data1718889509476'

    async up(db) {
        await db.query(`CREATE TABLE "spot_order" ("id" character varying NOT NULL, "order_type" character varying(4), "trader" text, "base_token" text, "base_size" text NOT NULL, "base_price" numeric, "timestamp" text, CONSTRAINT "PK_072f4b1d3bfcf52fc5927aa75ed" PRIMARY KEY ("id"))`)
