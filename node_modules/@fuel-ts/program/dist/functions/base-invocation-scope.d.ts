...
import type { Provider, CoinQuantity, Account, TransferParams } from '@fuel-ts/account';
...
export declare class BaseInvocationScope<TReturn = any> {
     ...
     */
    getTransactionCost(): Promise<import("@fuel-ts/account").TransactionCost>;
    /**
    ...
    get<T = TReturn>(): Promise<InvocationCallResult<T>>;
