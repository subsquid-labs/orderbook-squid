 ...
 */
export type InputValue<T = void> = Primitive | BN | Option<T> | BytesLike | InputValue[] | {
    [key: string]: InputValue;
} | Record<string, Primitive | BytesLike>;
/**
 * The type of value you can get from `Coder.decode`
 */
export type DecodedValue = Primitive | DecodedValue[] | {
...
export declare abstract class Coder<TInput = unknown, TDecoded = unknown> {
...
export {};
//# sourceMappingURL=AbstractCoder.d.ts.map