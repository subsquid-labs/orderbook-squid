...
export declare const FAILED_ASSERT_NE_SIGNAL = "0xffffffffffff0005";
export declare const FAILED_UNKNOWN_SIGNAL = "0x0";
export declare const PANIC_REASONS: string[];
export declare const PANIC_DOC_URL = "https://docs.rs/fuel-asm/latest/fuel_asm/enum.PanicReason.html";
