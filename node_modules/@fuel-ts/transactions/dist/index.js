...
var ReceiptCallCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    ...
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.gas));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.param1));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.param2));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.pc));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.is));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new import_abi_coder6.B256Coder().decode(data, o);
    const to = decoded;
    [decoded, o] = new import_abi_coder6.BigNumberCoder("u64").decode(data, o);
    const amount = decoded;
    [decoded, o] = new import_abi_coder6.B256Coder().decode(data, o);
    const assetId = decoded;
    [decoded, o] = new import_abi_coder6.BigNumberCoder("u64").decode(data, o);
...
var ReceiptReturnCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    ...
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.val));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.pc));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.is));
    return (0, import_utils5.concat)(parts);
  }
...
var ReceiptReturnDataCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder6.B256Coder().encode(value.id));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.ptr));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.len));
...
var ReceiptPanicCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder6.B256Coder().encode(value.id));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.reason));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.pc));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.is));
...
var ReceiptLogCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder6.B256Coder().encode(value.id));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.val0));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.val1));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.val2));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.val3));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.pc));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.is));
    return (0, import_utils5.concat)(parts);
  }
...
var ReceiptScriptResultCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.result));
    parts.push(new import_abi_coder6.BigNumberCoder("u64").encode(value.gasUsed));
    return (0, import_utils5.concat)(parts);
  }
  decode(data, offset) {
    let decoded;
...
var ReceiptMessageOutCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    ...
    parts.push(new import_abi_coder6.NumberCoder("u16", { padToWordSize: true }).encode(value.data.length));
    parts.push(new import_abi_coder6.B256Coder().encode(value.digest));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new import_abi_coder6.B256Coder().decode(data, o);
    const nonce = decoded;
    [decoded, o] = new import_abi_coder6.NumberCoder("u16", { padToWordSize: true }).decode(data, o);
    const len = decoded;
    [decoded, o] = new import_abi_coder6.B256Coder().decode(data, o);
    const digest = decoded;
    [decoded, o] = new ByteArrayCoder(len).decode(data, o);
    const messageData = (0, import_utils5.arrayify)(decoded);
...
var ReceiptCoder = class extends import_abi_coder6.Coder {
  ...
  encode(value) {
    const parts = [];
    parts.push(new import_abi_coder6.NumberCoder("u8", { padToWordSize: true }).encode(value.type));
    const { type } = value;
    switch (value.type) {
      case 0 /* Call */: {
  ...
  decode(data, offset) {
    let decoded;
    let o = offset;
    [decoded, o] = new import_abi_coder6.NumberCoder("u8", { padToWordSize: true }).decode(data, o);
    const type = decoded;
    switch (type) {
      case 0 /* Call */: {
    ...
    switch (value.type) {
      ...
      default: {
        throw new import_errors6.FuelError(
          import_errors6.ErrorCode.INVALID_TRANSACTION_TYPE,
          `Invalid transaction type: ${type}`
        );
      }
    }
...
var UtxoIdCoder = class extends import_abi_coder11.StructCoder {
  constructor() {
    super("UtxoId", {
      ...
      outputIndex: new import_abi_coder11.NumberCoder("u8", { padToWordSize: true })
    });
  }
};
