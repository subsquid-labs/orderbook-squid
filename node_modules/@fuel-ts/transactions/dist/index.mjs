...
var ReceiptMessageOutCoder = class extends Coder5 {
  ...
  encode(value) {
    ...
    parts.push(new NumberCoder5("u16", { padToWordSize: true }).encode(value.data.length));
    parts.push(new B256Coder3().encode(value.digest));
...
var ReceiptCoder = class extends Coder5 {
  ...
  encode(value) {
    const parts = [];
    parts.push(new NumberCoder5("u8", { padToWordSize: true }).encode(value.type));
    const { type } = value;
    switch (value.type) {
      case 0 /* Call */: {
...
import { Coder as Coder8, ArrayCoder, B256Coder as B256Coder6, NumberCoder as NumberCoder8, BigNumberCoder as BigNumberCoder5 } from "@fuel-ts/abi-coder";
...
import { B256Coder as B256Coder5, Coder as Coder6, NumberCoder as NumberCoder6 } from "@fuel-ts/abi-coder";
import { ErrorCode as ErrorCode5, FuelError as FuelError5 } from "@fuel-ts/errors";
import { concat as concat6 } from "@fuel-ts/utils";
var UpgradePurposeCoder = class extends Coder6 {
  constructor() {
  ...
  encode(upgradePurposeType) {
    ...
    parts.push(new NumberCoder6("u8", { padToWordSize: true }).encode(type));
    switch (type) {
      case 0 /* ConsensusParameters */: {
        const data = upgradePurposeType.data;
        parts.push(new NumberCoder6("u16", { padToWordSize: true }).encode(data.witnessIndex));
        parts.push(new B256Coder5().encode(data.checksum));
        break;
      }
      case 1 /* StateTransition */: {
        const data = upgradePurposeType.data;
        parts.push(new B256Coder5().encode(data.bytecodeRoot));
        break;
      }
      default: {
  ...
  decode(data, offset) {
    let o = offset;
    let decoded;
    [decoded, o] = new NumberCoder6("u8", { padToWordSize: true }).decode(data, o);
    const type = decoded;
    switch (type) {
      case 0 /* ConsensusParameters */: {
        [decoded, o] = new NumberCoder6("u16", { padToWordSize: true }).decode(data, o);
...
import { Coder as Coder7, NumberCoder as NumberCoder7 } from "@fuel-ts/abi-coder";
import { concat as concat7 } from "@fuel-ts/utils";
var WitnessCoder = class extends Coder7 {
  constructor() {
    super(
      "Witness",
  ...
  encode(value) {
    const parts = [];
    parts.push(new NumberCoder7("u32", { padToWordSize: true }).encode(value.dataLength));
...
var TransactionScriptCoder = class extends Coder8 {
  constructor() {
  ...
  encode(value) {
    ...
    parts.push(new B256Coder6().encode(value.receiptsRoot));
    ...
    parts.push(new NumberCoder8("u32", { padToWordSize: true }).encode(value.policyTypes));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.inputsCount));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.outputsCount));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.witnessesCount));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new B256Coder6().decode(data, o);
    const receiptsRoot = decoded;
    [decoded, o] = new BigNumberCoder5("u64").decode(data, o);
    const scriptLength = decoded;
    [decoded, o] = new BigNumberCoder5("u64").decode(data, o);
    const scriptDataLength = decoded;
    [decoded, o] = new NumberCoder8("u32", { padToWordSize: true }).decode(data, o);
    const policyTypes = decoded;
    [decoded, o] = new NumberCoder8("u16", { padToWordSize: true }).decode(data, o);
...
var TransactionCreateCoder = class extends Coder8 {
  constructor() {
    super("TransactionCreate", "struct TransactionCreate", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.bytecodeWitnessIndex));
    parts.push(new B256Coder6().encode(value.salt));
...
var TransactionMintCoder = class extends Coder8 {
  constructor() {
  ...
  encode(value) {
    ...
    parts.push(new B256Coder6().encode(value.mintAssetId));
...
var TransactionUpgradeCoder = class extends Coder8 {
  constructor() {
...
var TransactionUploadCoder = class extends Coder8 {
  constructor() {
    super("TransactionUpload", "struct TransactionUpload", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new B256Coder6().encode(value.root));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.witnessIndex));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.subsectionIndex));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.subsectionsNumber));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.proofSetCount));
    parts.push(new NumberCoder8("u32", { padToWordSize: true }).encode(value.policyTypes));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.inputsCount));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.outputsCount));
    parts.push(new NumberCoder8("u16", { padToWordSize: true }).encode(value.witnessesCount));
    parts.push(new ArrayCoder(new B256Coder6(), value.proofSetCount).encode(value.proofSet));
    parts.push(new PoliciesCoder().encode(value.policies));
    parts.push(new ArrayCoder(new InputCoder(), value.inputsCount).encode(value.inputs));
    parts.push(new ArrayCoder(new OutputCoder(), value.outputsCount).encode(value.outputs));
    parts.push(new ArrayCoder(new WitnessCoder(), value.witnessesCount).encode(value.witnesses));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new NumberCoder8("u16", { padToWordSize: true }).decode(data, o);
    const witnessesCount = decoded;
    [decoded, o] = new ArrayCoder(new B256Coder6(), proofSetCount).decode(data, o);
...
var TransactionCoder = class extends Coder8 {
  constructor() {
    super("Transaction", "struct Transaction", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new NumberCoder8("u8", { padToWordSize: true }).encode(value.type));
    const { type } = value;
    switch (value.type) {
      case 0 /* Script */: {
        parts.push(
      ...
      default: {
        throw new FuelError6(
          ErrorCode6.INVALID_TRANSACTION_TYPE,
          `Invalid transaction type: ${type}`
        );
      }
    }
  ...
  decode(data, offset) {
    let decoded;
    let o = offset;
    [decoded, o] = new NumberCoder8("u8", { padToWordSize: true }).decode(data, o);
    const type = decoded;
    switch (type) {
      case 0 /* Script */: {
...
import { B256Coder as B256Coder7, NumberCoder as NumberCoder9, StructCoder as StructCoder3 } from "@fuel-ts/abi-coder";
var UtxoIdCoder = class extends StructCoder3 {
  constructor() {
    super("UtxoId", {
      transactionId: new B256Coder7(),
      outputIndex: new NumberCoder9("u8", { padToWordSize: true })
    });
  }
};
export {
