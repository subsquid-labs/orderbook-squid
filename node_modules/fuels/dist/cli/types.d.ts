...
export type OptionsFunction = (options: ContractDeployOptions) => DeployContractOptions | Promise<DeployContractOptions>;
...
export type FuelsConfig = UserFuelsConfig & Required<Pick<UserFuelsConfig, 'contracts' | 'predicates' | 'scripts' | 'deployConfig' | 'autoStartFuelCore' | 'forcPath' | 'fuelCorePath' | 'providerUrl' | 'forcBuildFlags'>> & {
    basePath: string;
    configPath: string;
